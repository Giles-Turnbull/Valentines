...
FX.setFullscreen = function () {
    FX.width = FX.canvas.width = 200; // Set the canvas width to 200
    FX.height = FX.canvas.height = 200; // Set the canvas height to 200
};
...
FX.loop = function () {
    ...
    ctx.clearRect(0, 0, FX.width, FX.height); // Clear the canvas
